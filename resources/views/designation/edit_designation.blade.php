...
<div class="box box-primary">
	...
	<form class="form-horizontal" method="POST" action="{{action('DesignationController@update', $designation->id)}}">
    {{ csrf_field() }}
		...
		<div class="row">
	        ...
	        <div class="form-group has-feedback {{ $errors->has('designation') ? ' has-error' : '' }} col-lg-12 col-md-12 col-xs-12">  
	            <div class="col-lg-6">  
	                ...
	                <input type="text" class="form-control" name="designation" placeholder="Designation.." value="{{ $designation->designation_name or old('designation') }}" required autofocus >
	        ...
	        <div class="form-group has-feedback {{ $errors->has('alis') ? ' has-error' : '' }} col-lg-12 col-md-12 col-xs-12">  
	            <div class="col-lg-6">  
	              	<label>Alis</label>
	                <input type="text" class="form-control" name="alis" placeholder="Alis.." value="{{ $designation->alis or old('alis') }}" required>
		            @if ($errors->has('alis'))
		                <span class="help-block">
	        ...
	        <div class="form-group has-feedback {{ $errors->has('priority') ? ' has-error' : '' }} col-lg-12 col-md-12 col-xs-12">  
	            <div class="col-lg-6">  
	                ...
	                <input type="text" class="form-control" name="priority" placeholder="Priority.." value="{{ $designation->priority or old('priority') }}" required>
